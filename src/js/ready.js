$(function () {
  ...
  $(window).scroll(function () {
    if ($(this).scrollTop() > 300) {
      scrollButton
        .addClass("scroll-to-top__button--visible")
        .removeClass("scroll-to-top__button--hidden");
    } else {
      scrollButton
        .removeClass("scroll-to-top__button--visible")
        .addClass("scroll-to-top__button--hidden");
    }
  });
});
